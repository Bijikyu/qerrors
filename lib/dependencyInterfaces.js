 ...
 * testability and can be customized for different logging and monitoring needs across any
 ...
 * Enables dependency injection for testability and framework customization.
 * 
...
/**
 * Reset the default deps (useful for testing)
 */
function resetDefaultQerrorsCoreDeps() {
  defaultQerrorsCoreDeps = null; //(clear cached deps for test isolation)
}
...
module.exports = { //(export dependency injection utilities)
  ...
  resetDefaultQerrorsCoreDeps //(test helper to reset cached deps)
};
