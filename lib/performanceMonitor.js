...
/**
 * Simplified circular buffer for memory-efficient metrics storage
 */
class CircularBuffer {
  constructor(size = 50) { // Reduced default size
  ...
  // Simplified filter without full array conversion
  filter(predicate) {
    const result = [];
    for (let i = 0; i < this.count; i++) {
      const idx = (this.index - this.count + i + this.size) % this.size;
...
class PerformanceMonitor extends EventEmitter {
  constructor(options = {}) {
    ...
    this.metrics = {
      blockingOperations: new CircularBuffer(25),
      memorySnapshots: new CircularBuffer(20),
      gcPauses: new CircularBuffer(10),
      eventLoopLag: new CircularBuffer(25),
      cpuIntensiveOperations: new CircularBuffer(10),
      alerts: new CircularBuffer(10)
    };
