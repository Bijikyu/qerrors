...
function stringifyContext(ctx) { //safely stringify context without errors
  try {
    ...
    if (typeof ctx === 'object' && ctx !== null) {
      const seen = new Set(); //create seen set outside replacer
 ...
 * Uses built-in structuredClone for better performance and compatibility.
 */
function deepClone(obj) { //create deep copy of object without mutation risks
  try {
    return structuredClone(obj); //use built-in structured clone
  } catch {
