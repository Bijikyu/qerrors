...
class EnhancedRateLimiter {
  constructor(options = {}) {
    ...
    this.maxEndpointStats = 100; // Further reduced limit for memory efficiency
    this.maxEndpointHitTimes = 150; // Separate limit for hit timestamps
    
    // Cache for user agent hashes to avoid repeated computation - proper LRU
    this.userAgentHashCache = new Map();
    this.maxUserAgentCacheSize = 50; // Further reduced size for memory efficiency
