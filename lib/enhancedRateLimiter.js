...
class EnhancedRateLimiter {
  ...
  constructor(options = {}) {
    ...
    /**
     * Endpoint-specific rate limits optimized for different API categories
     * Each endpoint is configured based on its resource intensity and security requirements:
     * - Health checks: High limits for monitoring systems
     * - Metrics: Medium-high for observability tools
     * - Status: Medium for general application status
     * - Logs: Lower limits due to potential data volume
     * - Errors: Low limits to prevent data scraping
     * - Config: Very low limits for security-sensitive operations
     * - AI endpoints: Very low limits due to computational cost
     * - Admin/Debug: Low limits with longer windows for security
     */
    this.endpointLimits = {
