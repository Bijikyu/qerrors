...
// Load and validate concurrency limits for AI analysis - optimized for scalability
const rawConc = config.getInt('QERRORS_CONCURRENCY', 10);        // Increased default concurrency
const rawQueue = config.getInt('QERRORS_QUEUE_LIMIT', 500);    // Increased default queue limit
const SAFE_THRESHOLD = config.getInt('QERRORS_SAFE_THRESHOLD', 2000); // Increased safety threshold for larger deployments
