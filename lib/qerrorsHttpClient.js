...
const axiosInstance = axios.create({
  ...
  httpAgent: new http.Agent({
    ...
    maxSockets: MAX_SOCKETS,      // Limit concurrent connections
    maxFreeSockets: MAX_FREE_SOCKETS // Limit idle connections
  }),
  
  // HTTPS connection agent with same pooling strategy for secure requests
  httpsAgent: new https.Agent({
    keepAlive: true,              // Reuse SSL connections (avoids handshake overhead)
    maxSockets: MAX_SOCKETS,      // Limit concurrent secure connections
    maxFreeSockets: MAX_FREE_SOCKETS // Limit idle secure connections
  }),
