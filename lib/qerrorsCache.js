...
const adviceCache = new LRUCache({
  max: ADVICE_CACHE_LIMIT > 0 ? ADVICE_CACHE_LIMIT : 0,           // Entry limit (0 = no limit)
  ttl: (CACHE_TTL_SECONDS > 0 ? CACHE_TTL_SECONDS : 0) * 1000    // TTL in milliseconds (0 = no expiration)
});
