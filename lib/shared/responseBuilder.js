 ...
 *
 * Provides a fluent API for building complex HTTP responses
 * with support for status codes, data, errors, metadata, and headers.
 * Designed for Express.js applications requiring structured responses.
 */
 ...
 * Provides fluent interface for building consistent HTTP responses
 */
...
/**
   ...
   * @returns {ResponseBuilder} This instance for chaining
   */
  setStatus (status) {
    this.status = status;
    if (status >= 400) {
