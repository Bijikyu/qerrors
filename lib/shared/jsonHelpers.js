...
const { maskKey } = require('../sanitization.js');
...
/**
 * Stringify an object while masking sensitive API keys for safe logging.
 * Uses fast-safe-stringify for circular reference handling.
 * Keys containing 'apikey' (case-insensitive) will have their values masked.
 *
 * @param {any} obj - Object to stringify
 * @returns {string|undefined} JSON string with masked keys, or undefined on error
 */
function maskKeyStringify (obj) {
  try {
    return fastSafeStringify(obj, (key, value) => {
