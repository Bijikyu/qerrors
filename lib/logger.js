...
/**
 * Qerrors Logger Module
 * 
 * Provides centralized logging functionality for the qerrors system with
 * support for structured logging, performance monitoring, and security auditing.
 * Integrates with Winston for robust log management and supports multiple
...
/**
 * Initialize winston loggers for different purposes
 * - logger: Main production logger with all transports
 * - simpleLogger: Lightweight logger for simple operations
 */
const logger = buildLogger();
const simpleLogger = createSimpleWinstonLogger();

/**
 * In-memory log queue for buffering and batch processing
...
/**
 * Process queued log functions in batches to improve performance
 * Uses parallel processing with chunks to avoid blocking the event loop
 * Implements backpressure management and performance monitoring
 */
