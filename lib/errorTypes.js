...
module.exports = { //(export error handling utilities for use across qerrors module)
    ...
    ServiceError, //(enhanced error class with type, context, and cause)
    errorUtils, //(common error handling utilities)
    safeUtils //(result-type pattern for error-safe operations)
};