 ...
 */
const defaults={QERRORS_CONCURRENCY:'5',QERRORS_CACHE_LIMIT:'50',QERRORS_CACHE_TTL:'86400',QERRORS_QUEUE_LIMIT:'100',QERRORS_SAFE_THRESHOLD:'1000',QERRORS_RETRY_ATTEMPTS:'2',QERRORS_RETRY_BASE_MS:'100',QERRORS_RETRY_MAX_MS:'2000',QERRORS_TIMEOUT:'10000',QERRORS_MAX_SOCKETS:'50',QERRORS_MAX_FREE_SOCKETS:'256',QERRORS_MAX_TOKENS:'2048',QERRORS_OPENAI_URL:'https://api.openai.com/v1/chat/completions',QERRORS_LOG_MAXSIZE:String(1024*1024),QERRORS_LOG_MAXFILES:'5',QERRORS_LOG_MAX_DAYS:'0',QERRORS_VERBOSE:'true',QERRORS_LOG_DIR:'logs',QERRORS_DISABLE_FILE_LOGS:'',QERRORS_SERVICE_NAME:'qerrors',QERRORS_LOG_LEVEL:'info',QERRORS_METRIC_INTERVAL_MS:'30000'};
