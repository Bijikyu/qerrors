...
const validateRequiredVars = varNames => {
  // Optimized single-pass validation to avoid nested array operations
  const missing = [];
  const present = [];
...
module.exports={defaults,getEnv,safeRun,getInt,validateRequiredVars,getConfigSummary,getConfigSummarySync,loadDotenv};