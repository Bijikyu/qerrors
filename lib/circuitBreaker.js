 ...
 * 
 * Note: This is a simplified calculation that uses a fixed 100ms
 * response time for demonstration purposes. In a production
 * environment, you would want to measure actual response times.
 * 
 * @private
 */
_updateAverageResponseTime() {
  ...
  if (stats.total > 0) {
    // Calculate running average: new_avg = (old_avg * (n-1) + new_value) / n
    // Note: Using 100ms as placeholder for actual response time measurement
