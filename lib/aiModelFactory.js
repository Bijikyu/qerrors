 ...
 */
function createOpenAIAnalysisConfig(selectedModel, modelConfig) {
 ...
 */
function createGoogleAnalysisConfig(selectedModel, modelConfig) {
  return {
    modelName: selectedModel,
...
const createAnalysisModel = (provider, modelName) => {
  ...
  switch (provider) {
    case MODEL_PROVIDERS.OPENAI:
      const openaiConfig = createOpenAIAnalysisConfig(selectedModel, modelConfig);
      return new ChatOpenAI(openaiConfig);
      
    case MODEL_PROVIDERS.GOOGLE:
      const googleConfig = createGoogleAnalysisConfig(selectedModel, modelConfig);
