 ...
 */
export declare const createQerrorsCoreDeps: () => {};
/**
 ...
 */
export declare const getDefaultQerrorsCoreDeps: () => {};
/**
 ...
 */
export declare const createDefaultErrorHandlingDeps: () => {};
/**
 ...
 */
export declare const qerr: () => Promise<void>;
/**
 ...
 */
export declare const getErrorSeverity: () => {};
/**
 ...
 * @returns Promise that resolves immediately (no-op placeholder)
 */
export declare const logErrorWithSeverityDI: () => Promise<void>;
/**
 ...
 */
export declare const withErrorHandlingDI: () => () => void;
/**
 ...
 */
export declare const resetDefaultQerrorsCoreDeps: () => void;
//# sourceMappingURL=dependencyInterfaces.d.ts.map