 ...
 */
export declare const throwIfNotFound: <T>(entity: T | null | undefined, entityName: string) => T;
/**
 ...
 */
export declare const throwIfNotFoundObj: <T>(input: {
 ...
 */
export declare const throwIfNotFoundMany: (entities: Array<{
    entity: any;
    entityName: string;
}>) => {
    entity: any;
 ...
 */
export declare const throwIfNotFoundWithMessage: <T>(entity: T | null | undefined, errorMessage: string) => T;
/**
 ...
 */
export declare const entityExists: <T>(entity: T | null | undefined) => boolean;
/**
 ...
 * @throws Error when entity is null or undefined
 */
export declare const assertEntityExists: <T>(entity: T | null | undefined, entityName: string) => T;
