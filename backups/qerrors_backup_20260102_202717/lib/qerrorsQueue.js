...
const estimateItemMemoryUsage = (err, ctx) => {
    try {
        ...
        const itemRepresentation = {
            ...
            additionalProps: err ? Object.keys(err).filter(key => !['message', 'name', 'stack', 'code'].includes(key)).length : 0
        };
...
//# sourceMappingURL=qerrorsQueue.js.map