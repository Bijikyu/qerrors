...
import { createUnifiedTimer, safeRun, deepClone, attempt, executeWithQerrors, formatErrorMessage } from './shared/executionCore.js';
 ...
 */
const logError = async (error, context, metadata) => {
    try {
 ...
 */
const logInfo = async (message, metadata) => {
    try {
 ...
 */
const logWarn = async (message, metadata) => {
    try {
...
safeRun, deepClone, createTimer, attempt, executeWithQerrors, formatErrorMessage, 
// Legacy exports
