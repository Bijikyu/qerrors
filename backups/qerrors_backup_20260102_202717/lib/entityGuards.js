 ...
 */
export const throwIfNotFound = (entity, entityName) => {
    if (!entity)
 ...
 */
export const throwIfNotFoundObj = (input) => ({
    entity: input.entity,
    found: !!input.entity
});
/**
 ...
 */
export const throwIfNotFoundMany = (entities) => entities;
/**
 ...
 */
export const throwIfNotFoundWithMessage = (entity, errorMessage) => {
    if (!entity)
 ...
 * @throws Error when entity is null or undefined
 */
export const assertEntityExists = (entity, entityName) => {
    if (!entity)
